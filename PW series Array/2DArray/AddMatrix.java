...
public class AddMatrix {
    ...
    static int[][] Addition(int[][] arr1, int[][] arr2, int r1, int c1, int r2, int c2) {
        if (r1 != r2 || c1 != c2) {
            System.out.println("Wrong Input - Addition not possible");
            return null;
        }

        int[][] res = new int[r1][c1]; // Corrected the dimensions of the result matrix
        for (int i = 0; i < r1; i++) {
            for (int j = 0; j < c1; j++) {
    ...
    public static void main(String[] args) {
        ...
        int[][] res = Addition(arr1, arr2, r1, c1, r2, c2);
